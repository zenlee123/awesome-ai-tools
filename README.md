...
3. [Agent QA](https://github.com/vostride/agent-qa) 👉 FSL source-available application QA harness for defining, running, and triaging natural-language web and mobile tests. Free to install; configured model, browser, or device providers may charge separately.
